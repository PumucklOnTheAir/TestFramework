...
class TestNetworkInterface(TestCase):
    ...
    def test_create_network_interface(self):
        ...
        self.assertEqual(ipaddress.ip_interface("192.168.1.1/24"), network_interface.ip_address_lst[0])
        self.assertEqual(ipaddress.ip_interface("fe80::a11:96ff:fe05:3024/64"), network_interface.ip_address_lst[1])
