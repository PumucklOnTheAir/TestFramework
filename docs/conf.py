# -*- coding: utf-8 -*-
#
# Freifunk TestFramework documentation
#
...
project = u'Freifunk TestFramework'
copyright = u'PumucklOnTheAir'
...
man_pages = [
    ('index', 'freifunk', u'Freifunk Documentation', 1)
]
